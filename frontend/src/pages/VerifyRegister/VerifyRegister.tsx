...
export function VerifyRegister({ className, ...props }: React.ComponentProps<'div'>) {
    ...
    return (
        <div className={cn('flex flex-col gap-5 max-w-md w-full mx-auto justify-center min-h-[calc(100vh-200px)]', className)} {...props}>
                    ...
                    <form className='p-5 sm:p-6' onSubmit={onSubmit}>
                        <div className='flex flex-col gap-5'>
                            <div className='flex flex-col items-center gap-2 text-center'>
                                ...
                                <p className='text-muted-foreground text-sm text-balance'>Mã xác nhận đã được gửi vào email của bạn. Vui lòng kiểm tra và nhập mã để hoàn tất đăng ký.</p>
                            </div>
                            ...
                            <div className='flex min-w-0 flex-col gap-2'>
                                ...
                                {errors.root && (
                                    <p className='text-destructive mt-1 text-xs break-words'>{errors.root.message}</p>
                                )}
                            </div>
